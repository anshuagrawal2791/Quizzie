...
public class TopicActivity extends Activity {
    ...
    ArrayList<String> QuestionsPlayed=new ArrayList<>();
    String parsetable;
    TextView leveltv;
    int level2=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<QuestionsPlayed.size();i++)
        {
            if(QuestionsPlayed.get(i)!=null)
                level2++;
        }
        //level2 = QuestionsPlayed.size();
        leveltv.setText("Level " + (level2 / 10 + 1));
        Log.e("Qplayedtopicactivity",QuestionsPlayed.toString());

        Log.e("Level2 TopicActivity",""+level2);
