...
public class Profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //user.put("class",null);
        if (user.getString("class") != null&&!user.getString("class").equals("Select Class")) {
        ...
        //user.put("city",null);
        if (user.getString("city") != null&&!user.getString("city").equals("City")) {

            city.setText(user.getString("city").toUpperCase());
    ...
    public void onResume() {
        ...
        //user.put("city",null);
        if (user.getString("city") != null&&!user.getString("city").equals("City")&&!user.getString("city").equals("")) {
